    ...
    return (
        <div className='container' style={{justifyContent: 'space-around',alignItems: 'center',display: 'flex',background: darkmode? 'rgb(40, 40, 40)' : 'rgb(250, 250, 250)' }}>
            ...
            <div> 
                ...
                >
                    <svg className="point" xmlns="http://www.w3.org/2000/svg" fill={state.darkmode? 'white' : 'black'} id="Outline" viewBox="0 0 24 24" width="32" height="32"><rect y="11" width="24" height="2" rx="1"/><rect y="4" width="24" height="2" rx="1"/><rect y="18" width="24" height="2" rx="1"/></svg>
                </div>
